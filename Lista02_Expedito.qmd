...
10. Exiba o número do departamento (`DNO`), o número do funcionário (`ENO`) e o nome de todos os funcionários (`ENAME`). Ordene o resultado pelo número do funcionário (em ordem crescente) dentro do número do departamento (em ordem decrescente).
